"""Natural-language side of the system.

Pipeline::

    complaint sentence
        -> all-mpnet-base-v2 sentence embedding (768-dim, L2-normalised)
        -> intent classifier  -> one of six classes
        -> severity scorer    -> continuous score in [0, 1]
